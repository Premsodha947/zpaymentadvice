...
@EndUserText.label: 'CDS FOR PARTIAL PAYMENT'
...
define view entity ZPARTIAL1_PAYMENT as select from I_OperationalAcctgDocItem as A


left outer join I_JournalEntryItem as M on ( M.AccountingDocument = A.InvoiceReference and M.Ledger = '0L') 
